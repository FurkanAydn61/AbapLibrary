...
FORM set_fcat .
  ...
  gs_fcat-scrtext_l = 'SİL'.
  gs_fcat-style = cl_gui_alv_grid=>mc_style_button. "Button aktif etmek için"
  gs_fcat-icon = abap_true."Icon özelliğini aktif ettik"
...
FORM display_alv .
  IF go_grid IS INITIAL.
    ...
    SET HANDLER go_event_receiver->handle_button_click FOR go_grid. "Kullanmak istediğimiz metotu çağırdık"
