...
FORM data_fetch .
  ...
  IF it_scarr IS NOT INITIAL.
    SELECT carrid connid FROM spfli INTO TABLE it_spfli FOR ALL ENTRIES IN it_scarr
       WHERE carrid = it_scarr-carrid.
    IF it_spfli IS NOT INITIAL.
      SELECT
        carrid connid fldate
        FROM sflight INTO TABLE it_sflight FOR ALL ENTRIES IN it_spfli
