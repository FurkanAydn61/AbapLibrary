...
*--------------------------------------------------------------------------------------------------------------------*
    ...
    TRY.
        ...
        DATA(lt_main_text) = VALUE bcsy_text( ( line = 'Deneme raporu ektedir.'(009) )
                                              ( line = 'İyi Çalışmalar'(010) ) ).
        ...
        IF ld_bytecount < ld_maxbytecount.
          ...
          CONCATENATE '&SO_FILENAME=' 'Deneme Excel Dosyası.XLSX'(005) INTO lv_text_line."Must end in XLSX or XLSM
          APPEND lv_text_line TO lt_att_head.

          lo_document->add_attachment( i_attachment_type    = 'EXT'
                                       i_attachment_subject = 'Deneme Excel Dosyası.XLSX'(005)
